...
次のordererメトリクスは、Prometheusで利用するために出力されます。

+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| Name                                         | Type      | Description                                                                    | Labels    |
+==============================================+===========+================================================================================+===========+
| blockcutter_block_fill_duration              | histogram | 最初のトランザクションがエンキューされてからブロックがカットされるまでの時間（秒） | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| broadcast_enqueue_duration                   | histogram | トランザクションをエンキューするまでの時間（秒）　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | type      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | status    |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| broadcast_processed_count                    | counter   | 処理されたトランザクションの数　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | type      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | status    |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| broadcast_validate_duration                  | histogram | トランザクションを認証するための時間（秒）　　　　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | type      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | status    |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_egress_queue_capacity           | gauge     | Egress queueの容量　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | host      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | msg_type  |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_egress_queue_length             | gauge     | Egress queueの長さ　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | host      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | msg_type  |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_egress_queue_workers            | gauge     | Egress queueのワーカー数　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_egress_stream_count             | gauge     | 他ノードへのストリーム数　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_egress_tls_connection_count     | gauge     | 他ノードへのTLSコネクション数　　　　　　　　　　　　　　　　　　　　　　　　　　　|           |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
...
|                                              |           |                                                                                | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| cluster_comm_msg_send_time                   | histogram | メッセージ送信にかかった時間（秒）　　　　　　　　　　　　　　　　　　　　　　　　 | host      |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_active_nodes              | gauge     | このチャネルでアクティブなノードの数　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_cluster_size              | gauge     | このチャネルのノードの数　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_committed_block_number    | gauge     | コミットされた最新ブロックのブロック数　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_config_proposals_received | counter   | コンフィグタイプのトランザクションで受信した提案の合計数　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_data_persist_duration     | histogram | etcd/raftデータがストレージに永続化されるまでの時間（秒）　　　　　　　　　　　　  | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_is_leader                 | gauge     | 現在のノードのリーダーシップステータス： 1 はリーダー、そうでなければ 0　　　  | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_leader_changes            | counter   | プロセスがスタートしてからのリーダー変更数　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_normal_proposals_received | counter   | 通常タイプのトランザクションで受信した提案の合計数　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_proposal_failures         | counter   | 提案の失敗数　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_etcdraft_snapshot_block_number     | gauge     | 最新スナップショットのブロック数　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_batch_size                   | gauge     | トピックに送信された平均バッチサイズ（バイト）　　　　　　　　　　　　　　　　　　 | topic     |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_compression_ratio            | gauge     | トピックの平均圧縮率（％）　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | topic     |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_incoming_byte_rate           | gauge     | ブローカーの読み込みバイト数/秒　　　　　　　　　　　　　　　　　　　　　　　　  | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_last_offset_persisted        | gauge     | もっとも最近コミットされたブロックのブロックメタデータに規定されたオフセット　　　 | channel   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_outgoing_byte_rate           | gauge     | ブローカーの書き込みバイト数/秒　　　　　　　　　　　　　　　　　　　　　　　　  | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_record_send_rate             | gauge     | トピックに送られたレコード数/秒　　　　　　　　　　　　　　　　　　　　　　　　  | topic     |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_records_per_request          | gauge     | トピックに送られたリクエストあたりの平均レコード数　　　　　　　　　　　　　　　　 | topic     |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_request_latency              | gauge     | ブローカーへの平均リクエストレイテンシ（ms）　　　　　　　　　　　　　　　　　　 | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_request_rate                 | gauge     | ブローカーに送信したリクエスト/秒　　　　　　　　　　　　　　　　　　　　　　　  | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_request_size                 | gauge     | ブローカーへの平均リクエストサイズ（バイト）　　　　　　　　　　　　　　　　　　　 | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_response_rate                | gauge     | ブローカーへ送られたリクエスト数/秒　　　　　　　　　　　　　　　　　　　　　　  | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| consensus_kafka_response_size                | gauge     | ブローカーからの平均レスポンスサイズ（バイト）　　　　　　　　　　　　　　　　　　 | broker_id |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| deliver_blocks_sent                          | counter   | デリバーサービスによって送られたブロック数　　　　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | filtered  |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | data_type |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| deliver_requests_completed                   | counter   | 完了したデリバーリクエストの数　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | filtered  |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | data_type |
...
|                                              |           |                                                                                | success   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| deliver_requests_received                    | counter   | 受信したデリバーリクエストの数　　　　　　　　　　　　　　　　　　　　　　　　　　 | channel   |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | filtered  |
|                                              |           |                                                                                +-----------+
|                                              |           |                                                                                | data_type |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| deliver_streams_closed                       | counter   | デリバーサービスのためにクローズされたGRPCストリームの数　　　　　　　　　　　　 |           |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| deliver_streams_opened                       | counter   | デリバーサービスのためにオープンしたGRPCストリームの数　　　　　　　　　　　　　 |           |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| fabric_version                               | gauge     | Fabricのアクティブなバージョン　　　　　　　　　　　　　　　　　　　　　　　　 | version   |
+----------------------------------------------+-----------+--------------------------------------------------------------------------------+-----------+
| grpc_comm_conn_closed                        | counter   | gRPC コネクションがクローズしたconnections closed. Open minus closed is the active   |           |
